...
const Services = () => {
  ...
  return <section id="services" className="py-24 bg-gradient-to-b from-pink-50 via-orange-50 to-yellow-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          <h2 className="text-6xl font-bold bg-gradient-to-r from-pink-600 via-orange-600 to-yellow-600 bg-clip-text text-transparent mb-6"> Services</h2>
          <div className="w-24 h-1 bg-gradient-to-r from-pink-500 to-yellow-500 mx-auto mb-6 rounded-full"></div>
          <p className="text-2xl font-semibold bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text text-transparent max-w-3xl mx-auto">Bringing your ideas to life with vibrant creativity! </p>
        </div>

        <div className="grid lg:grid-cols-3 gap-10 mb-20">
          {services.map((service, index) => <Card key={service.title} className={`p-10 bg-gradient-to-br ${service.bgGradient} border-0 shadow-2xl hover:shadow-2xl transition-all duration-500 group hover:scale-110`} style={{
          animationDelay: `${index * 200}ms`
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-4">
                  {service.features.map(feature => <li key={feature} className="flex items-center text-gray-700 hover:text-gray-900 transition-colors group/feature">
