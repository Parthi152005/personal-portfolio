  ...
  return <section id="contact" className="py-24 bg-gradient-to-b from-purple-50 via-pink-50 to-orange-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          <p className="text-2xl font-semibold bg-gradient-to-r from-pink-600 to-orange-600 bg-clip-text text-transparent max-w-3xl mx-auto">Let's chat! </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-10">
            ...
            <Card className="p-10 bg-gradient-to-br from-white via-pink-50 to-orange-50 border-0 shadow-2xl hover:shadow-pink-300 transition-all duration-500 hover:scale-105">
              <h3 className="text-3xl font-bold bg-gradient-to-r from-pink-600 to-orange-600 bg-clip-text text-transparent mb-8">Follow My Journey </h3>
              <div className="flex space-x-6">
                <a href="https://linkedin.com/in/parthi-ban-0910152a5" target="_blank" rel="noopener noreferrer" className="p-4 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 rounded-2xl transition-all duration-300 hover:scale-125 group shadow-lg hover:shadow-blue-300">
                  <Linkedin className="w-8 h-8 text-white" />
                </a>
                <a href="https://github.com/Parthi152005" target="_blank" rel="noopener noreferrer" className="p-4 bg-gradient-to-r from-gray-700 to-gray-900 hover:from-gray-800 hover:to-black rounded-2xl transition-all duration-300 hover:scale-125 group shadow-lg hover:shadow-gray-400">
                  <Github className="w-8 h-8 text-white" />
                </a>
                <a href="mailto:parthi15august@gmail.com" className="p-4 bg-gradient-to-r from-red-500 to-pink-600 hover:from-red-600 hover:to-pink-700 rounded-2xl transition-all duration-300 hover:scale-125 group shadow-lg hover:shadow-red-300">
